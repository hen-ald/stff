...
### Behov av yta fullstor 11-spelarplan per kommun
...
### Linjärt samband mellan antal lag i en kommun och behov av fler planer
...
### Antal lag per capita (personer 7 - 20 år)
...
### Behov yta fullstor 11-spelarplan per capita (personer 7 - 20 år)
...
### Nyckeltalet räknas ut genom att befolkningen delas med antalet befintliga fotbollsplaner tillsammans med behovet av fotbollsplaner enligt StFF.

#### Befolkningen (7 - 20 år) / (befintliga + behovet av fotbollsplaner) = nyckeltalet
...
### Negativt linjärt samband mellan lag per capita och nyckeltal

#### Storleken på cirklarna är behov per capita
